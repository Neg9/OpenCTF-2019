...
['brclr', 'OP_BITMASK | OP_JUMP_REL  | OP_DIRECT', '4', '0x13', '6', '6', 'CHG_NONE', 'cpu6811', '0'],
['brclr', 'OP_BITMASK | OP_JUMP_REL  | OP_IX', '4', '0x1f', '7', '7', 'CHG_NONE', 'cpu6811', '0'],
['brclr', 'OP_BITMASK | OP_JUMP_REL  | OP_IY | OP_PAGE2', '5', '0x1f', '8', '8', 'CHG_NONE', 'cpu6811', '0'],
['brclr', 'OP_BITMASK | OP_JUMP_REL  | OP_DIRECT', '4', '0x4f', '4', '4', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brclr', 'OP_BITMASK | OP_JUMP_REL  | OP_IND16', '5', '0x1f', '5', '5', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brclr', 'OP_BITMASK | OP_JUMP_REL  | OP_IDX', '4', '0x0f', '4', '4', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brclr', 'OP_BITMASK | OP_JUMP_REL  | OP_IDX_1', '5', '0x0f', '6', '6', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brclr', 'OP_BITMASK  | OP_JUMP_REL  | OP_IDX_2', '6', '0x0f', '8', '8', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brn', 'OP_JUMP_REL', '2', '0x21', '1', '3', 'CHG_NONE', 'cpu6811|cpu6812|cpu9s12x', '0'],
['brset', 'OP_BITMASK | OP_JUMP_REL  | OP_DIRECT', '4', '0x12', '6', '6', 'CHG_NONE', 'cpu6811', '0'],
['brset', 'OP_BITMASK  | OP_JUMP_REL  | OP_IX', '4', '0x1e', '7', '7', 'CHG_NONE', 'cpu6811', '0'],
['brset', 'OP_BITMASK | OP_JUMP_REL  | OP_IY | OP_PAGE2', '5', '0x1e', '8', '8', 'CHG_NONE', 'cpu6811', '0'],
['brset', 'OP_BITMASK | OP_JUMP_REL  | OP_DIRECT', '4', '0x4e', '4', '4', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brset', 'OP_BITMASK | OP_JUMP_REL  | OP_IND16', '5', '0x1e', '5', '5', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brset', 'OP_BITMASK | OP_JUMP_REL  | OP_IDX', '4', '0x0e', '4', '4', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brset', 'OP_BITMASK | OP_JUMP_REL  | OP_IDX_1', '5', '0x0e', '6', '6', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['brset', 'OP_BITMASK | OP_JUMP_REL  | OP_IDX_2', '6', '0x0e', '8', '8', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
...
['call', 'OP_IND16 | OP_PAGE          | OP_BRANCH', '4', '0x4a', '8', '8', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['call', 'OP_IDX | OP_PAGE          | OP_BRANCH', '3', '0x4b', '8', '8', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['call', 'OP_IDX_1 | OP_PAGE          | OP_BRANCH', '4', '0x4b', '8', '8', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['call', 'OP_IDX_2 | OP_PAGE          | OP_BRANCH', '5', '0x4b', '9', '9', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['call', 'OP_D_IDX          | OP_BRANCH', '2', '0x4b', '10', '10', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['call', 'OP_D_IDX_2          | OP_BRANCH', '4', '0x4b', '10', '10', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
...
['dbeq', 'OP_DBEQ_MARKER          | OP_REG | OP_JUMP_REL', '3', '0x04', '3', '3', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['dbne', 'OP_DBNE_MARKER          | OP_REG | OP_JUMP_REL', '3', '0x04', '3', '3', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
...
['exg', 'OP_EXG_MARKER          | OP_REG | OP_REG_2', '2', '0xb7', '1', '1', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
...
['ibeq', 'OP_IBEQ_MARKER          | OP_REG | OP_JUMP_REL', '3', '0x04', '3', '3', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['ibne', 'OP_IBNE_MARKER          | OP_REG | OP_JUMP_REL', '3', '0x04', '3', '3', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
...
['sex', 'M6812_OP_SEX_MARKER          | OP_REG | OP_REG_2', '2', '0xb7', '1', '1', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
...
['tbeq', 'OP_TBEQ_MARKER          | OP_REG | OP_JUMP_REL', '3', '0x04', '3', '3', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['tbl', 'OP_IDX | OP_PAGE2', '3', '0x3d', '8', '8', 'CHG_NZC', 'cpu6812|cpu9s12x', '0'],
['tbne', 'OP_TBNE_MARKER          | OP_REG | OP_JUMP_REL', '3', '0x04', '3', '3', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
['tfr', 'OP_TFR_MARKER          | OP_REG_1 | OP_REG_2', '2', '0xb7', '1', '1', 'CHG_NONE', 'cpu6812|cpu9s12x', '0'],
...
['tfr', 'M68XG_OP_R', '2', '0x00f8', '0', '0', '0', '0', '0', 'cpuxgate', '0xf8ff'], # RD
['tfr', 'M68XG_OP_R', '2', '0x00f9', '0', '0', '0', '0', '0', 'cpuxgate', '0xf8ff'], # CCR
['tfr', 'M68XG_OP_R', '2', '0x00fa', '0', '0', '0', '0', '0', 'cpuxgate', '0xf8ff'], # RD
...
['bhs', 'M68XG_OP_REL9', '2', '0x2000', '0', '0', '0', '0', '0', 'cpuxgate', '0x0000'],
['bcs', 'M68XG_OP_REL9', '2', '0x2200', '0', '0', '0', '0', '0', 'cpuxgate', '0xfe00'],
['blo', 'M68XG_OP_REL9', '2', '0x2200', '0', '0', '0', '0', '0', 'cpuxgate', '0xfe00'],
...
['ldw', 'M68XG_OP_R_IMM16', '2', '0xf000', '0', '0', '0', '0', '0', 'cpuxgate']
]
# TODO: Opcode aliases
"""
